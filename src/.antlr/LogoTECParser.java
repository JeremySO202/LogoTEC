...
public class LogoTECParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, HAZ=3, INIC=4, INC=5, AVANZA=6, RETROCEDE=7, GIRADERECHA=8, 
		GIRAIZQUIERDA=9, PONPOS=10, PONXY=11, PONRUMBO=12, RUMBO=13, PONX=14, 
		PONY=15, CENTRO=16, BAJALAPIZ=17, SUBELAPIZ=18, PONCOLORLAPIZ=19, OCULTATORTUGA=20, 
		ESPERA=21, EJECUTA=22, REPITE=23, SI=24, HAZ_HASTA=25, HASTA=26, HAZ_MIENTRAS=27, 
		MIENTRAS=28, Y=29, O=30, IGUALES=31, MAYORQUE=32, MENORQUE=33, DIFERENCIA=34, 
		AZAR=35, PRODUCTO=36, POTENCIA=37, DIVISION=38, SUMA=39, PARA=40, FIN=41, 
		BOOLEAN=42, COLOR=43, IGUAL=44, SEMICOLON=45, SQUARE_OPEN=46, SQUARE_CLOSE=47, 
		BRACKET_OPEN=48, BRACKET_CLOSE=49, PAR_OPEN=50, PAR_CLOSE=51, COMILLA=52, 
		STRING=53, ID=54, NUMERO=55, LETRAS=56, GUION_BAJO=57, DIGITO=58, ESPACIO=59, 
		SALTO_LINEA=60, WS=61;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'//'", "'-'", "'HAZ'", "'INIC'", "'INC'", null, null, null, null, 
			"'PONPOS'", "'PONXY'", "'PONRUMBO'", "'RUMBO'", "'PONX'", "'PONY'", "'CENTRO'", 
			null, null, null, null, "'ESPERA'", "'EJECUTA'", "'REPITE'", "'SI'", 
			"'HAZ.HASTA'", "'HASTA'", "'HAZ.MIENTRAS'", "'MIENTRAS'", "'Y'", "'O'", 
			"'IGUALES?'", "'MAYORQUE?'", "'MENORQUE?'", "'DIFERENCIA'", "'AZAR'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "HAZ", "INIC", "INC", "AVANZA", "RETROCEDE", "GIRADERECHA", 
			...
			"BRACKET_CLOSE", "PAR_OPEN", "PAR_CLOSE", "COMILLA", "STRING", "ID", 
			"NUMERO", "LETRAS", "GUION_BAJO", "DIGITO", "ESPACIO", "SALTO_LINEA", 
			"WS"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1729383356958760954L) != 0)) {
				{
				setState(107);
				_errHandler.sync(this);
