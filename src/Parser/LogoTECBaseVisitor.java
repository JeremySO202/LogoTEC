...
public class LogoTECBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements LogoTECVisitor<T> {
	 ...
	 */
	@Override public T visitProg(LogoTECParser.ProgContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitStat(LogoTECParser.StatContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitExpr(LogoTECParser.ExprContext ctx) { return visitChildren(ctx); }
}