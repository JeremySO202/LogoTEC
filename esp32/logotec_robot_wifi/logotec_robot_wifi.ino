/*
 * LogoTEC Robot WiFi - Servidor de Control Remoto HTTP
 *
 * Hardware:
 * - ESP32-D0WD-V3
 ...
 * - Recibe comandos Logo vía POST a /cmd
 * - Control preciso de giro usando MPU6050
 * - Movimiento adelante/atrás con control PD
...
// ============================================
// CONFIGURACIÓN WiFi - EDITAR SEGÚN TU RED
// ============================================
const char *WIFI_SSID = "Serracin-Mendez"; // Cambiar por tu SSID
const char *WIFI_PASSWORD = "Nohaywifi";   // Cambiar por tu contraseña
...
void setup()
{
    ...
    Serial.begin(115200);
    Serial.println("\n=================================");
    Serial.println("LogoTEC - Robot WiFi Server");
    Serial.println("=================================\n");
...
void handleRoot()
{
    ...
    html += "<title>LogoTEC Robot</title></head><body>";
    html += "<h1>LogoTEC Robot WiFi</h1>";
    html += "<p>Servidor HTTP activo</p>";
    html += "<p>IP: " + WiFi.localIP().toString() + "</p>";
    html += "<h2>Uso:</h2>";
    html += "<code>POST /cmd</code><br>";
    html += "<code>Body: COMANDO parametros</code><br><br>";
    html += "<b>Ejemplos:</b><br>";
    html += "RESET<br>AVANZA 100<br>GIRADERECHA 90<br>";
    html += "</body></html>";
...
void handleCommand()
{
    if (server.hasArg("plain"))
    {
        ...
        // Responder con JSON
        String json = "{\"status\":\"ok\",\"command\":\"" + cmd + "\",\"result\":\"" + result + "\"}";
    ...
    {
        server.send(400, "application/json", "{\"status\":\"error\",\"message\":\"No command in body\"}");
    }
}
